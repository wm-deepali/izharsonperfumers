...
<img src="{{ URL::asset('storage/' . $headerdata->header_logo) }}" style="height: 50px;">
            ...
            <div class="mt-4 heading">
                <h2>Reset Password Successfull</h2>
                <p>Thank you for joining IZARHSON PERFUMERS. Click the button below to login.</p>
                <a href="https://www.website.rugabode.com/Login"><div class="btn-btnverify">Login</div></a>
            </div>
