...
<img src="{{ URL::asset('storage/' . $headerdata->header_logo) }}" style="height: 50px;">
            ...
            <div class="mt-4 heading">
                ...
                <p>Thank you for joining IZARHSON PERFUMERS. Click the button below to confirm that this is correct email to reach you.</p>
                <a href="{{$token}}"><div class="btn-btnverify">VERIFY EMAIL</div></a>
            </div>
