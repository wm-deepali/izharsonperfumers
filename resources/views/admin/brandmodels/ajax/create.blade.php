            ...
            <div class="modal-body">
                ...
                <div class="col-sm-4">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Arabic Car Model	" name="name_ar" id="name_ar">
                ...
                <!-- <div class="col-sm-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-check">
                          <input type="checkbox" class="form-check-input" id="check3" name="fueltype[]" value="Electric Vehicle">
...
@endphp
                    ...
                    <div class="form-check">
                          <input type="checkbox" class="form-check-input" id="check2" name="cylinder[]" value="{{$cylinder->id}}" >
                ...
                <div class="form-group row">
                    <div class="col-sm-4">
                        ...
                        <span class="note-span" id="meta_title_ar-limit">We recommend title between 50–60 characters.(0 character)</span>
                        <div class="text-danger" id="meta_title_ar-err"></div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="text-danger" id="meta_keyword_ar-err"></div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        ...
                        <span class="note-span" id="meta_description_ar-limit">We recommend descriptions between 50–160 characters.(0 character)</span>
                        <div class="text-danger" id="meta_description_ar-err"></div>
                    </div>
                </div>
                --}}
            </div>
