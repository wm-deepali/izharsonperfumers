                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-xs-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Manage Attribute</li>
                        </ol>
                    </div>
                </div>
            </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-truncate">
                                                                <ul class="actions">
                                                                    ...
                                                                    <li><a href="javascript:void(0)" class="edit-attribute" attribute_id="{{ $attribute->id }}" title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i></a></li>
