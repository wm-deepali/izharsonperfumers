                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                @if (isset($blog->image) && Storage::exists($blog->image))
                                                                    <img src="{{ URL::asset('storage/' . $blog->image) }}" class="img-fluid" style="height:50px;">
                                                                @else
                                                                    NA
                                                                @endif
                                                            </td>
                                                            ...
                                                            <td class="text-truncate">
                                                                <ul class="actions">
                                                                    <li><a href="javascript:void(0)" class="edit-blog" blog_id="{{ $blog->id }}" title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i></a></li>
                                                                    <li><a href="javascript:void(0)" onclick="deleteConfirmation({{ $blog->id }})" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></a></li>
                                                                </ul>
                                                            </td>
                                                        </tr>
                                                    @endforeach
