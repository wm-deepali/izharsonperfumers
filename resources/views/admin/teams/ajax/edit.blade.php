<div class="modal-dialog modal-lg">
    ...
    <form class="form form-horizontal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="text" class="form-control" value="{{$team->name_ar}}" placeholder="Enter Name Arabic" name="name_ar" id="name_ar">
                        <div class="text-danger" id="name_ar-err"></div>
                    </div>
                    @endif
                    <div class="col-sm-6">
                        <label class="label-control label">Designation <span class="required">*</span></label>
                        <input type="text" class="form-control" value="{{$team->designation}}" placeholder="Enter Designation" name="designation" id="designation">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="text" class="form-control" value="{{$team->designation_ar}}" placeholder="Enter Designation Ar" name="designation_ar" id="designation_ar">
                ...
                <div class="form-group row">
                <div class="col-md-4">
                        <img src="{{ URL::asset('storage/' . $team->image) }}" id="preview-image class="img-fluid" style="height:50px;">
                    </div>
                    <div class="col-md-4">
            ...
            <button type="button" class="btn btn-primary" id="update-team-btn" team_id="{{ $team->id }}">Submit</button>
