            ...
            <div class="modal-body">
                    ...
                    <div class="col-sm-6 form-group">
                      ...
                      <div class="col-sm-6 form-group">
                        ...
                        <select class="form-control" name="status" id="status">
                            ...
                            <option value="block" @if ($category->status == 'block') selected @endif>De-Active</option>
                        </select>
                ...
                <div class="row">
                   ...
                   <div class="col-sm-4 form-group">
                        ...
                        <textarea class="form-control" rows="2" cols="7" placeholder="Enter Canonical Tag" name="canonical_tags" id="canonical_tags">{{ $category->meta->canonical_tags }}</textarea>
                        
                        <div class="text-danger" id="canonical_tags-err"></div>
                    </div>
                    <div class="col-sm-4 form-group">
                        <label class="label-control label">Twitter Cards</label>
                        <textarea class="form-control" rows="2" cols="7" placeholder="Enter Twitter Cards" name="twitter_cards" id="twitter_cards">{{ $category->meta->twitter_cards }}</textarea>
                        
                        <div class="text-danger" id="twitter_cards-err"></div>
                    </div>
                    <div class="col-sm-4 form-group">
                        <label class="label-control label">OG Tags</label>
                        <textarea class="form-control" rows="2" cols="7" placeholder="Enter OG Tags" name="og_tags" id="og_tags">{{ $category->meta->og_tags }}</textarea>
