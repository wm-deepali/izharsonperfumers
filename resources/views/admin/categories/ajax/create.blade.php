            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 form-group">
                        <label class="label-control label">@if(url()->previous() == url('admin/manage-category')) Category @else Sub-Category @endif Name <span class="required">*</span></label>
                        <input type="text" class="form-control" placeholder="Enter @if(url()->previous() == url('admin/manage-category')) Category @else Sub-Category @endif Name" name="name" id="name">
 ...
 @if(url()->previous() == url('admin/manage-category'))
               <div class="row">
                  ...
                  <div class="col-md-6 form-group">
                        <label class="label-control label">@if(isset($category->parent_id)) Sub-Category @else Category @endif Icon <span class="required">*</span> <span
                                class="text-danger">(@if(isset($category->parent_id)) Sub-Category @else Category @endif Icon Size 500*500)</span></label>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 form-group">
                        ...
                        <textarea class="form-control" rows="2" cols="7" placeholder="Enter Canonical Tag" name="canonical_tags" id="canonical_tags"></textarea>
                        
                        <div class="text-danger" id="canonical_tags-err"></div>
                    </div>
                    <div class="col-sm-4 form-group">
                        <label class="label-control label">Twitter Cards</label>
                        <textarea class="form-control" rows="2" cols="7" placeholder="Enter Twitter Cards" name="twitter_cards" id="twitter_cards"></textarea>
                        
                        <div class="text-danger" id="twitter_cards-err"></div>
                    </div>
                    <div class="col-sm-4 form-group">
                        <label class="label-control label">OG Tags</label>
                        <textarea class="form-control" rows="2" cols="7" placeholder="Enter OG Tags" name="og_tags" id="og_tags"></textarea>
