                        ...
                        <form class="form form-horizontal">
                            <div class="form-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" placeholder="Enter " name="description" id="description" value="{{ $coupon->description }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                        <select class="form-control" name="discount_type" id="discount_type">
                                            <option value="percentage" @if ($coupon->discount_type == 'percentage') selected @endif>Percent (%)</option>
                                            <option value="amount" @if ($coupon->discount_type == 'amount') selected @endif>Rupee (INR)</option>
                                        </select>
                                        <div class="text-danger validation-err" id="discount_type-err"></div>
                                    </div>
                                    <label class="col-md-2 label-control">Discount amount*</label>
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" placeholder="Enter Discount" name="discount_amount" id="discount_amount" value="{{ $coupon->discount_amount }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" placeholder="Enter Max Discount" name="maximum_discount" id="maximum_discount" value="{{ $coupon->maximum_discount }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                        <input type="date" class="form-control" placeholder="Enter Start Date" onchange="TDate()" name="start_date" id="start_date" value="{{ $coupon->start_date }}">
                                        <div class="text-danger validation-err" id="start_date-err"></div>
                                    </div>
                                    <label class="col-md-2 label-control">End Date*</label>
                                    <div class="col-md-4">
                                        <input type="date" class="form-control" placeholder="Enter End Date" onchange="ETDate()" name="end_date" id="end_date" value="{{ $coupon->end_date }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" placeholder="Enter Amount" name="subtotal_start" id="subtotal_start" value="{{ $coupon->subtotal_start }}">
                                        <div class="text-danger validation-err" id="subtotal_start-err"></div>
                                    </div>
                                    <label class="col-md-2 label-control">Subtotal end*</label>
                                    <div class="col-md-4">
                                        <input type="number" class="form-control" placeholder="Enter Amount" name="subtotal_end" id="subtotal_end" value="{{ $coupon->subtotal_end }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                        <select class="form-control" name="status" id="status">
                                            ...
                                            <option value="block" @if ($coupon->status == 'block') selected @endif>Block</option>
                                        </select>
                                    ...
                                    <div class="col-md-4">
                                        <select class="form-control" name="limit_use" id="limit_use">
                                            <option value="yes" @if ($coupon->limit_use == 'yes') selected @endif>Yes</option>
                                            <option value="no" @if ($coupon->limit_use == 'no') selected @endif>No</option>
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" placeholder="Enter No. of uses" name="number_of_use" id="number_of_use" value="{{ $coupon->number_of_use }}" min="1">
                                        ...
                                        <select class="form-control" name="categories" id="categories" multiple style="height:250px;">
                                            ...
                                            @if (isset($categories) && count($categories) > 0)
                                                @foreach ($categories as $category)
                                                    <option value='{{ $category->id }}' @if (in_array($category->id, explode(',', $coupon->categories))) selected @endif>{{ $category->name }}</option>
                                                    @if (isset($category->all_childs) && count($category->all_childs) > 0)
                                                        @foreach ($category->all_childs as $all_child)
                                                            @include('admin.coupons.category-tree', ['child_Children' => $all_child, 'coupon' => $coupon])
                                                        @endforeach
                                                    @endif
                                                @endforeach
                                            @endif
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12 text-center mt-3">
                                        <button type="button" class="btn adminbtn-blue btn-lg" id="update-coupon-btn" coupon_id="{{ $coupon->id }}">Submit</button>
                                    </div>
                                </div>
                            </div>
                        </form>
...
function ETDate() {
    ...
    $(document).ready(function() {
        $(document).on("click", "#update-coupon-btn", function(event) {
            ...
            $.ajax({
                url: `{{ URL::to('admin/manage-coupon/${coupon_id}') }}`,
                type: 'POST',
                processData: false,
                contentType: false,
                dataType: 'json',
