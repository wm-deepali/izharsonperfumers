    ...
    <form class="form form-horizontal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Oil Grade Name Arabic" name="name_ar" id="name_ar" >
                    ...
                    @endif
                        ...
                        <input type="date" class="form-control" onchange="TDate()" placeholder="Enter Validity Date" name="validity" id="validity" >
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="add-promotion-btn" >Submit</button>
