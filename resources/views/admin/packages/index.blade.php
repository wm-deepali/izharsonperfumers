                ...
                <div class="card-header">
                    ...
                    <div class="heading-elements">
                        <ul class="list-inline mb-0">
                            <li><a href="{{ URL::to('admin/manage-packages/create') }}" id="add-category1"><i class="fa fa-plus"></i> Add </a></li>
                                                ...
                                                @if (isset($objs) && count($objs) > 0)
                                                    @foreach ($objs as $item)
                                                        <tr>
                                                            ...
                                                            <td>{{ $item->discountable_price.' '. $item->currency_type }}</td>
                                                            ...
                                                            <td>
                                                                ...
                                                                <span class="badge badge-warning danger"><i class="fa fa-times"></i> De-Active</span>
                                                                @endif
                                                            </td>
                                                            <td class="text-truncate">
                                                                <ul class="actions">
                                                                <li><a href="{{route('admin.manage-packages.showpack',$item->id)}}" class="show-service" service_id="{{ $item->id }}" title="View"><i class="fa fa-eye" aria-hidden="true"></i></a></li>
                                                                    <li><a href="{{ URL::to('admin/manage-packages/'.$item->id.'/edit') }}" class="edit-category1" category_id="{{ $item->id }}" title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i></a></li>
                                                                    <li><a href="javascript:void(0)" onclick="deleteConfirmation({{ $item->id }})" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></a></li>
                                                                    <li><a href="javascript:void(0)" onclick="updateStatus({{ $item->id }})" title="Status">@if($item->status =="active")<i style="color:green" class="fa fa-check" aria-hidden="true"></i>@else <i style="color:red" class="fa fa-times" aria-hidden="true"></i> @endif</a></li>
...
function updateStatus(id){
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: `{{ URL::to('admin/manage-packages/change-status/${id}') }}`,
                    type: "POST",
                    brandType: "json",
