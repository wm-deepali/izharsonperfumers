...
.wm-gateway-row:last-child {
    border-bottom: none;
}

.wm-gateway-row:hover {
    background: #fafbf9;
}
...
/* Custom switch — overrides theme's default .switch look */
.wm-switch {
    position: relative;
    display: inline-block;
    width: 46px;
    ...
    <div class="content-wrapper">
        ...
        <div class="account-setting-section">
            <ul id="accounttab" class="nav nav-tabs" role="tablist">
                ...
                <li class="nav-item">
                    <a id="tab-profile" href="#pane-profile" class="nav-link active" data-toggle="tab" role="tab">Admin
                        Profile</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a id="tab-gst" href="#pane-gst" class="nav-link" data-toggle="tab" role="tab">GST & Invoice
                        Setting</a>
                </li>
                <li class="nav-item">
                    <a id="tab-payment" href="#pane-payment" class="nav-link" data-toggle="tab" role="tab">Payment
                        Gateway</a>
                </li>
                ...
                <li class="nav-item">
                    <a id="tab-password" href="#pane-password" class="nav-link" data-toggle="tab" role="tab">Password
                        Setting</a>
                </li>
            ...
            <div id="accountcontent" class="tab-content" role="tablist">
                <div id="pane-profile" class="card tab-pane fade show active in" role="tabpanel"
                    aria-labelledby="tab-profile">
                    <div class="card-body">
                        <form method="POST" id="profileform" action="{{route('admin.updateadminprofile')}}"
                            ...
                            <div class="row form-group">
                                <div class="col-xl-4 col-lg- col-md-6 col-12">
                                    ...
                                    <img src="{{ URL::asset('storage/' . auth()->user()->image) }}"
                                        style="width:60px" />
                                </div>

                                <div class="col-xl-4 col-lg-6 col-md-6 col-12">
                                    <div class="wdinput form-group">
                                        <label>Admin Logo (Login Page)<span class="text-danger">(Image Size
                                                500*500)</span></label>
                                        <input type="file" class="form-control" placeholder="" name="image_login_page">
                                        <div class="text-danger" id="image_login_page-err"></div>
                                        <img src="{{ URL::asset('storage/' . auth()->user()->image_login_page) }}"
                                            style="width:60px" />
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-6 col-12">
                                    <div class="wdinput form-group">
                                        <label>Admin Logo (Admin Header)<span class="text-danger">(Image Size
                                                500*500)</span></label>
                                        <input type="file" class="form-control" placeholder="" name="image_header">
                                        <div class="text-danger" id="image_header-err"></div>
                                        <img src="{{ URL::asset('storage/' . auth()->user()->image_header) }}"
                                            style="width:60px" />
                                    </div>
                                </div>
                            </div>
                            <div class="row form-group">
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-6 col-12">
                                    <div class="wdinput form-group">
                                        ...
                                        <input type="email" class="form-control" placeholder="" name="alert_email"
                                            value="{{auth()->user()->alert_email}}">
                        ...
                        <div class="card-block card-orders-detail p-0">
                            <div class="card">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <a href="javascript:void(0)" class="btn btn-md btn-primary" id="add_address"><i
                                            class="fa fa-plus"></i> Add New Branch</a>
                                </div>
                                <hr />
                                <section>
                                    <div class="row">
                                                                ...
                                                                @if (isset($datas) && count($datas) > 0)
                                                                    @foreach ($datas as $data)
                                                                        <tr>
                                                                            ...
                                                                            <td>{{ $data->status == "active" ? "Active" : "De-Active" }}
                                                                            </td>
                                                                            <td class="text-truncate">
                                                                                <ul class="actions">
                                                                                    ...
                                                                                    <li><a href="javascript:void(0)"
                                                                                            ...
                                                                                            title="Status">@if($data->status == "active")<i
                                                                                                style="color:green"
                                                                                                class="fa fa-check"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="wdinput form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Company Name"
                                                    name="company_name" value="{{$settinggst->company_name}}">
                                            ...
                                            <div class="wdinput form-group">
                                                ...
                                                <select class="form-control" name="country" id="country">
                                                    ...
                                                    @foreach($countrys as $country)
                                                        <option @if($settinggst->country_id == $country->id) selected @endif
                                            ...
                                            <div class="wdinput form-group">
                                                ...
                                                <select class="form-control" name="state" id="state">
                                                    ...
                                                    @foreach($states as $state)
                                                        <option @if($settinggst->state_id == $state->id) selected @endif
                                            ...
                                            <div class="wdinput form-group">
                                                ...
                                                <select class="form-control" name="city" id="city-dropdown">
                                                    ...
                                                    @foreach($cities as $city)
                                                        <option @if($settinggst->city_id == $city->id) selected @endif
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-12">
                                            <div class="wdinput form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Pincode"
                                                    name="pin_code" value="{{$settinggst->pin_code}}">
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-12">
                                            <div class="wdinput form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="GST Number"
                                                    name="gst_number" value="{{$settinggst->gst_number}}">
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-12">
                                            <div class="wdinput form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="PAN Card Number"
                                                    name="pan_number" value="{{$settinggst->pan_number}}">
                                        ...
                                        <div class="col-md-12">
                                            <div class="wdinput form-group">
                                                ...
                                                <textarea class="form-control" rows="3" placeholder="Full Address"
                                                    name="invoice_address">{{$settinggst->invoice_address}}</textarea>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                            <div class="wdinput form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter Prefix"
                                                    name="invoice_prefix" value="{{$settinggst->invoice_prefix}}">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                            <div class="wdinput form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                    placeholder="Enter Serial Number" name="invoice_number"
                                                    value="{{$settinggst->invoice_number}}">
                                ...
                                <div class="row">
                                    <div class='col-sm-12'>
                                        ...
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" id="enabledChecked"
                                                name="status" value="enabled" @if($settinggst->gst_status == "yes")
                                                checked @endif>
                                            <label class="custom-control-label" for="enabledChecked">GST</label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            <input type="radio" value="other" class="custom-control-input"
                                                id="disabledChecked" name="status" @if($settinggst->vat_status == "yes")
                                                checked @endif>
                                            <label class="custom-control-label" for="disabledChecked">VAT</label>
                                        </div>
                                    </div>
                                ...
                                <div class="gst_show mt-2" @if($settinggst->gst_status == "no") hidden @endif>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="wdinput form-group">
                                                <label>IGST</label>
                                                <input type="text" class="form-control" name="igst_percent"
                                                    value="{{$settinggst->igst_percent}}">
                ...
                <div id="pane-payment" class="card tab-pane fade" role="tabpanel" aria-labelledby="tab-payment">
                    ...
                    <div class="card-body">
                        <h3 class="mb-3">Payment Gateway Status</h3>

                        <div class="wm-gateway-list">

                            <div class="wm-gateway-row">
                                <div class="wm-gateway-info">
                                    <span class="wm-gateway-name">CCAvenue</span>
                                    <span class="wm-gateway-desc">Card / UPI / Net Banking</span>
                                </div>
                                <label class="wm-switch">
                                    <input type="checkbox" class="gateway-toggle" data-gateway="ccavenue"
                                        @if(($statuses['ccavenue'] ?? false)) checked @endif>
                            ...
                            <div class="wm-gateway-row">
                                <div class="wm-gateway-info">
                                    <span class="wm-gateway-name">Cashfree</span>
                                    <span class="wm-gateway-desc">Card / UPI / Net Banking / Wallets</span>
                                </div>
                                <label class="wm-switch">
                                    <input type="checkbox" class="gateway-toggle" data-gateway="cashfree"
                                        @if(($statuses['cashfree'] ?? false)) checked @endif>
                                    <span class="wm-slider"></span>
                                </label>
                            </div>
                    ...
                    {{-- Bank Account details form stays as-is, unchanged --}}
                    <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-lg-3 col-md-3 col-12">
                                        <div class="wdinput form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter Account Name"
                                                value="{{$bank->ac_name}}" name="ac_name">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-3 col-12">
                                        <div class="wdinput form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter Account Number"
                                                value="{{$bank->ac_number}}" name="ac_number">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-3 col-12">
                                        <div class="wdinput form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter IFSC Code"
                                                value="{{$bank->ifsc_code}}" name="ifsc_code">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-3 col-12">
                                        <div class="wdinput form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter Bank Branch"
                                                value="{{$bank->bank_branch}}" name="bank_branch">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-3 col-12">
                                        <div class="wdinput form-group">
                                            ...
                                            <input type="file" class="form-control" value="{{$bank->payment_image}}"
                                    ...
                                    <div class="col-xl-3 col-lg-6 col-md-3 col-12">
                                        <div class="wdinput form-group">
                                            <img id="paymentimgpre" height="300px"
                                                src="{{url('storage') . '/' . $bank->payment_image}}" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        <form method="POST" id="emailform" action="{{route('admin.updateemailsetting')}}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-12">
                                        <div class="wdinput form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter MAIL FROM"
                                                name="mail_from" value="{{$mail->mail_from}}">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-12">
                                        <div class="wdinput form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter MAIL ENCRYPTION"
                                                name="encryption" value="{{$mail->encryption}}">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-12">
                                        <div class="wdinput form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter MAIL FROM NAME"
                                                name="name" value="{{$mail->name}}">
                                            <div class="text-danger" id="name-err"></div>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="wdinput form-group">
                                        <button class="btn adminbtn-blue btn-lg email-update-btn"
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                                    <div class="wdinput mt-2">
                                        <button type="submit"
                                            class="btn adminbtn-blue btn-lg update-password-btn">Update</button>
                                    </div>
                                </div>
                            </div>
                        </form>
...
<script>
    ...
    $(document).on("change", ".gateway-toggle", function () {
        ...
        $.ajax({
            url: "{{ url('admin/toggle-payment-gateway') }}",
            type: "POST",
            data: {
                _token: '{{csrf_token()}}',
                gateway: gateway,
