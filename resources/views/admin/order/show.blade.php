                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                @if($order->order_status=="Cancelled" || $order->order_status=="Delivered") <button class="btn btn-danger btn-sm">Order {{ $order->order_status }}</button>
                                @else <button class="btn btn-primary btn-sm cancel-order" type="button" brand_id="{{$order->id}}">Order {{ $order->order_status }}</button> @endif
                                
                                
                                @if ($order->order_status =='Cancelled' && $order->payment_status !='refunded')
                                <button class="btn btn-primary btn-sm refundprocess" type="button" brand_id="{{$order->id}}">Refund Amount</button>
                                ...
                                <a href="{{route('admin.invoice',$order->id)}}" class="btn btn-blue btn-sm"><i class="fa fa-download"></i> Download Invoice</a>
                                @if($order->payment_status=="pending")
                                <button class="btn btn-primary btn-sm approvepayment" type="button" brand_id="{{$order->id}}">Approve Payment</button>
                                @else
                                        ...
                                        <div class="col-sm-8">
                                            <div class="card">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-4 mb-2">
                                                        ...
                                                        <h3 class="h3-control">{{$order->order_amount_with_shipping}}</h3>
                                                    </div>
                                                    <div class="col-sm-4 mb-2">
                                                    ...
                                                    <div class="col-sm-4 mb-2">
                                                        ...
                                                        <h3 class="h3-control">{{ date("jS  F Y h:i:s A",strtotime($order->payment_approved_date)) }}</h3>
                                                    </div>
                                                    @endif
                                                    ...
                                                    <div class="col-sm-4 mb-2">
                                                        ...
                                                        <h3 class="h3-control">{{ $order->coupon_id ? 'Applied':'Not Applied' }}</h3>
                                                    </div>
                                                    <div class="col-sm-4 mb-2">
                                                    ...
                                                    <div class="col-sm-4 mb-2">
                                                       ...
                                                       <a href="{{url('storage').'/'.$order->payment_image}}" target="_blank"> <img height="100px" width="100px" src="{{url('storage').'/'.$order->payment_image}}" /></a>
                                                    </div>
                                                    @endif
                                                     @if ($order->cancelorder)
                                                    <div class="col-sm-4 mb-2">
                                                        <label class="label-control">Cancellation Reason Admin</label>
                                                        <h3 class="h3-control">{{$order->cancelorder->cancellation_reason_admin}}</h3>
                                                    </div>
                                                     <div class="col-sm-4 mb-2">
                                                        <label class="label-control">Cancellation Reason Customer</label>
                                                        <h3 class="h3-control">{{$order->cancelorder->cancellation_reason}}</h3>
                                                    </div>
                                                    <div class="col-sm-4 mb-2">
                                                        <label class="label-control">Reason</label>
                                                        <h3 class="h3-control">{{$order->cancelorder->reasons->title ?? ""}}</h3>
                                                    </div>
                                                    <div class="col-sm-4 mb-2">
                                                        <label class="label-control">Cancelled By</label>
                                                        <h3 class="h3-control">{{ ucfirst($order->cancelorder->cancelled_by)}}</h3>
                                                    </div>
                                            @endif
                                             @if ($order->cancelorder && $order->refundorder)
                                                    ...
                                                    <div class="col-sm-4 mb-2">
                                                        <label class="label-control">Transaction ID</label>
                                                        <h3 class="h3-control">{{$order->refundorder->transaction_id}}</h3>
                                                    </div>
                                                    <div class="col-sm-4 mb-2">
                                                        <label class="label-control">Refunded Amount</label>
                                                        <h3 class="h3-control">{{$order->refundorder->refunded_amount}}</h3>
                                                    </div>
                                                    <div class="col-sm-4 mb-2">
                                                        <label class="label-control">Refund Date </label>
                                                        <h3 class="h3-control">{{ date('d/m/Y H:i A', strtotime($order->refundorder->refunded_date))}}</h3>
                                                    </div>
                                             ...
                                             @if ($order->courierorder)
                                                    ...
                                                    <div class="col-sm-4 mb-2">
                                                        ...
                                                        <h3 class="h3-control">{{$order->courierorder->courier_name}}</h3>
                                                    </div>
                                                    <div class="col-sm-4 mb-2">
                                                        <label class="label-control">Deliver In</label>
                                                        <h3 class="h3-control">{{ $order->courierorder->delivery_date}} Days</h3>
                                                    </div>
                                                @endif
                                                </div>
                                                <div class="form-group row">
                                            ...
                                            <div class="table-responsive">
                                                <table id="recent-orders" class="table table-bordered table-hover">
                                                    <tbody>
                                                        <form method="POST" action="{{ route('admin.add-shipping-to-order', $order->id) }}">
                                                            @csrf
                                                            <tr>
                                                                <th>Shipping Type</th>
                                                                <td>
                                                                    <select class="form-control" id="shipping_type" name="shipping_type" required>
                                                                        ...
                                                                        <option value="valet" @if ($order->shipping_type == 'valet') selected @endif>Valet</option>
                                                                        <option value="courier" @if ($order->shipping_type == 'courier') selected @endif>Courier</option>
                                                                    </select>
                                                                    <div class="text-danger" id="shipping_type-err"></div>p
                                                                </td>
                                                                <th>Shipping By</th>
                                                                <td>
                                                                        ...
                                                                        <select class="form-control" id="shipping_by" name="shipping_by" required>
                                                                            ...
                                                                            @if (isset($shippings) && count($shippings) > 0)
                                                                                @foreach ($shippings as $shipping)
                                                                                    <option value="{{ $shipping->id }}" @if ($shipping->id == $order->shipping_id) selected @endif>{{ $shipping->name }}-({{ $shipping->mobile_number }})</option>
                                                                                @endforeach
                                                                            @endif
                                                                        </select>
                                                        ...
                                                        <tr>
                                                            <form method="POST" action="{{ route('admin.add-tracking-to-order', $order->id) }}">
                                                                @csrf
                                                                <th>Tracking Number</th>
                                                                <td>
                                                                    <div class="input-group-flex">
                                                                        <input type="text" class="form-control" placeholder="Enter Tracking Number" aria-describedby="button-addon2" name="tracking_number" id="tracking_number" value="{{ $order->tracking_number }}" required>
                                                                ...
                                                                <td>
                                                                    <div class="input-group-flex">
                                                                        <input type="text" class="form-control" placeholder="Enter Tracking Information" aria-describedby="button-addon2" name="tracking_detail" id="tracking_detail" value="{{ $order->tracking_detail }}" required>
                                                                    ...
                                                                    <table width="500" border="0" cellpadding="0" cellspacing="0" align="right">
                                                                      <tbody> 
                                                                        <tr>
                                                                          <td>
                                                                            <!-- Table Total -->
                                                                            <table width="480" border="0" cellpadding="0" cellspacing="0" align="right" class="fullPadding">
                                                                              <tbody>
                                                                                <tr>
                                                                                  <td class="text-right">Product Mrp</td>
                                                                                  <td class="text-right"> <i class="fa fa-inr"></i>{{ $order->order_amount }} </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="text-right">Pre Discount</td>
                                                                                  <td class="text-right text-success">{{number_format( (float) $prediscount, 2, '.', '')}}</td>
                                                                                </tr>
                                                                                <tr>
                                                                                  <td class="text-right">Coupon Discount</td>
                                                                                  <td class="text-right text-success"><i class="fa fa-inr"></i>{{ $order->discount_amount }}</td>
                                                                                </tr>
                                                                                 <tr>
                                                                                    <td class="text-right">Sub Total</td>
                                                                                  <td class="text-right text-success">{{ $order->order_amount_after_discount }}</td>
                                                                                </tr>
                                                                                @if($order->shipping_type_price != "0")
                                                                                <tr>
                                                                                  <td class="text-right">Shipping Charges</td>
                                                                                  <td class="text-right text-danger"><i class="fa fa-inr"></i>{{ $order->shipping_type_price }}</td>
                                                                                </tr>
                                                                                @endif
                                                                                <!--<tr>-->
                                                                                ...
                                                                                <tr>
                                                                                  ...
                                                                                  <td class="text-right"><i class="fa fa-inr"></i>{{ $order->order_amount_with_shipping }}</td>
                                                                                </tr>
                                                                              </tbody>
                                                                            </table>
                                                                            <!-- /Table Total -->
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <h3 class="h3-control">{{ $order->shippingaddress->address }}</h3>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <!--<div class="col-sm-6">-->
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <h3 class="h3-control">{{ $order->shippingaddress->mobile_number }}</h3>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-sm-12">
                                         ...
                                         <div class="col-sm-4">
                                            <div class="card">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <label class="label-control">Mobile No.</label>
                                                        <h3 class="h3-control">{{ $order->billingaddress->mobile_number }}</h3>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-sm-12">
