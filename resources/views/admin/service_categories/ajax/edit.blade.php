            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Service Name	" name="name" id="name" value="{{ $category->name }}">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Arabic Service Name" name="name_ar" id="name_ar" value="{{ $category->name_ar }}">
                    ...
                    <div class="col-sm-4">
                        ...
                        <label class="switch">
                        <input type="checkbox" class="form-control" name="other_service"  @if($category->other_service =='yes') checked @endif id="other_service">
                    ...
                    <div class="col-sm-4">
                        ...
                        <label class="switch">
                        <input type="checkbox" class="form-control"  name="value_added_service"  @if($category->value_added_service =='yes') checked @endif id="value_added_service">
                        <span class="slider round"></span>
                    </label>
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Slug URL" name="slug" id="slug" value="{{ $category->slug }}">
                ...
                <div class="form-group row">
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control" cols="4" rows="2"
                            placeholder="Enter Detail"
                            name="description"
                            id="description_ar">{{$category->description_ar}}</textarea>
                        <div class="text-danger validation-err"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Meta Title" name="meta_title" id="meta_title" maxlength="60" value="{{ $category->meta->meta_title }}">
                    ...
                    <div class="col-sm-6">
                        ...
                        <textarea class="form-control" rows="4" cols="7" placeholder="Enter Meta Keywords" name="meta_keyword" id="meta_keyword">{{ $category->meta->meta_keyword }}</textarea>
                    ...
                    <div class="col-sm-6">
                        ...
                        <textarea class="form-control" rows="4" cols="7" placeholder="Enter Meta Description" name="meta_description" id="meta_description" maxlength="160">{{ $category->meta->meta_description }}</textarea>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Meta Title" name="meta_title_ar" id="meta_title_ar" maxlength="60" value="{{ $category->meta_title_ar }}">
                        <span class="note-span" id="meta_title-limit">We recommend title between 50–60 characters.(0 character)</span>
                    ...
                    <div class="col-sm-6">
                        ...
                        <textarea class="form-control" rows="4" cols="7" placeholder="Enter Meta Keywords" name="meta_keyword_ar" id="meta_keyword_ar">{{ $category->meta_keyword_ar }}</textarea>
                    ...
                    <div class="col-sm-6">
                        ...
                        <textarea class="form-control" rows="4" cols="7" placeholder="Enter Meta Description" name="meta_description_ar" id="meta_description_ar" maxlength="160">{{ $category->meta_description_ar }}</textarea>
                        <span class="note-span" id="meta_description-limit">We recommend descriptions between 50–160 characters.(0 character)</span>
