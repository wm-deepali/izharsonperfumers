    ...
    <form class="form form-horizontal">
        <div class="modal-content">
            ...
            <label class="label-control label">Meta Keywords *</label>
                <input type="text" id="metakeywords" class="form-control" placeholder="Enter Meta Keywords" name="meta_keywords" id="meta_keywords" >
            </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="add-career-btn">Add</button>
