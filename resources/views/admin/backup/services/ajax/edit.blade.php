        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <label class="label-control label">Service Category <span class="required">*</span></label>
                        <select id="service_category_id" class="form-control">
                            <option value="">-- Select --</option>
                            @foreach($service_cats as $obj)
                                <option value="{{ $obj->id }}" {{ $category->service_category_id == $obj->id ? 'selected' : ''}}>{{ $obj->name }}</option>
                            @endforeach
                        </select>
                        <div class="text-danger validation-err" id="service_category_id-err"></div>
                    </div>
