    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-xs-12 mb-2">
                <h3 class="content-header-title mb-0">SERVICE BOOKINGS</h3>
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-xs-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                            {{-- <li class="breadcrumb-item">Catalog</li> --}}
                            <li class="breadcrumb-item active">Manage Service Bookings</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xl-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">MANAGE - Service Bookings</h4>
                                                ...
                                                @if (isset($objs) && count($objs) > 0)
                                                    @foreach ($objs as $itm)
                                                        <tr>
                                                            ...
                                                            <td>{{ \App\Models\ServiceBookings::GetUserName($itm->user_id) }}</td>
                                                            <td>{{ \App\Models\ServiceBookings::GetServiceCatName($itm->service_id) }}</td>
