...
<body style="font-family: 'Poppins', sans-serif;">
    <div style="border: 1px solid #ddd; padding-left: 15px;">
        ...
        <!--    <img src="{{ URL::asset('storage/' . $headerdata->header_logo) }}" style="height: 50px; margin-bottom: 20px; margin:0px auto 10px;">-->
        <!--</div>-->
            ...
            <table style="width:100%">
                ...
                <tr style="border-bottom: 1px solid #ddd; ">
                    ...
                    <td colspan="3" style="text-align: right;">
                        ...
                        <p style="font-size: 12px;margin-bottom: 0px;"> <strong>Invoice Number </strong> : <span>{{ $gstsetting->invoice_prefix."-".$gstsetting->financial_year."/".$gstsetting->invoice_number }}</span></p>
  ...
  <span style="font-size:11px; font-weight:400">
    ...
    / {{ $order_detail->brand_name }})
                            ...
                            <td style="padding:10px; border:1px solid #ddd; ">{{ $order_detail->total_price }}</td>
                            
                        </tr>
                    @endforeach
                @endif
                <tr style=" font-size: 14px; font-weight: normal;">
                    <td colspan="6" style="text-align: right"> <strong style="padding: 0px 10px"> Product Mrp </strong> </td>
                    <td style="padding:10px; border:1px solid #ddd; "> Rs {{ $order->order_amount }} </td>
                </tr>
                <tr style=" font-size: 14px; font-weight: normal;">
                    <td colspan="6" style="text-align: right"> <strong style="padding: 0px 10px"> Pre  Discount </strong> </td>
                    <td style="padding:10px; border:1px solid #ddd; "> Rs {{number_format( (float) $prediscount, 2, '.', '')}} </td>
                </tr>
                  <tr style=" font-size: 14px; font-weight: normal;">
                    <td colspan="6" style="text-align: right"> <strong style="padding: 0px 10px"> Coupon Discount </strong> </td>
                ...
                <tr style=" font-size: 14px; font-weight: normal;">
                    ...
                    <td style="padding:10px; border:1px solid #ddd; "> Rs {{ $order->order_amount_after_discount }} </td>
                </tr>
