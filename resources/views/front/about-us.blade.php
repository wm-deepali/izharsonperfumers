        ...
        <div class="row">
            <div class="col-sm-6 col-lg-3">
                <div class="aboutus_thumb">
                    <img class="img-fluid w100" src="images/about/1.jpg" alt="About1 Image">
                </div>
            </div>
            <div class="col-sm-6 col-lg-3">
                <div class="aboutus_thumb">
                    <img class="img-fluid w100" src="images/about/2.jpg" alt="About2 Image">
                </div>
                <div class="aboutus_thumb">
                    <img class="img-fluid w100" src="images/about/3.jpg" alt="About3 Image">
                </div>
            </div>
            <div class="col-sm-6 col-lg-3">
                <div class="aboutus_thumb">
                    <img class="img-fluid w100" src="images/about/4.jpg" alt="About4 Image">
                </div>
            </div>
            <div class="col-sm-6 col-lg-3">
                <div class="aboutus_thumb">
                    <img class="img-fluid w100" src="images/about/5.jpg" alt="About5 Image">
                </div>
                <div class="aboutus_thumb">
                    <img class="img-fluid w100" src="images/about/6.jpg" alt="About6 Image">
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-xl-10 m-auto pt30">
                ...
                <div class="about_us_content mb30 mt15">
                    <h4 class="title">Since 1985, we’re creating the awesome products & promise to give high quality
                        in the eCommerce market for all our customers residing any part of the world.</h4>
                    <p>Ut enim nunc, luctus vel nulla id, lacinia ultrices libero. Maecenas quis interdum nibh.
                        Suspendisse purus nibh, vestibulum porttitor orci et, egestas maximus ligula. Proin pharetra
                        convallis est, ut aliquam nisl consequat cursus. Donec ut finibus dui. felis urna, feugiat
                        ac auctor in, euismod ut sapien. Cras nulla felis, faucibus sit amet aliquet a, vestibulum
                        vitae turpis. Sed a interdum lectus, in varius purus. Cras maximus nulla in felis semper
                        hendrerit. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium
                        doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et
                        quasi architecto beatae vitae dicta sunt explicabo.Quis nostrud exercitation ullamco laboris
        ...
        <div class="row mt30">
            <div class="col-xl-10 m-auto pt60 bdrt1">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="main-title">
                            <h2 class="mtitle">In in mattis erat, eu mattis libero. <br class="d-none d-md-block">
                                Donec volutpat faucibus elit cursus <br class="d-none d-md-block"> interdum</h2>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="main-title">
                            <p class="mb30">Nullam accumsan nulla in arcu condimentum imperdiet. Class aptent taciti
                                ...
                                lacinia purus vitae lorem porttitor fermentum. In in mattis erat, eu mattis libero.
                            </p>
                            <p class="mb25">ociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.
                                Curabitur lacinia purus vitae lorem porttitor fermentum. In in mattis erat, eu
                                mattis libero. Donec volutpat faucibus elit cursus interdum.</p>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="zmart_testimonial1">
                                <div class="review mb30 text-center">
                                    <ul>
                                        <li class="list-inline-item"><a href="#"><span class="fas fa-star"></span></a>
                                        </li>
                                        <li class="list-inline-item"><a href="#"><span class="fas fa-star"></span></a>
                                        </li>
                                        <li class="list-inline-item"><a href="#"><span class="fas fa-star"></span></a>
                                ...
                                <div class="testimonial_contents text-center">
                                    <p class="main_title">Sallum dictum felis eu pede mollis pretium. Integer
                                    ...
                                    <p class="author_post">Fashion Designer</p>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
