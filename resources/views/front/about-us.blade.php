            ...
            <div class="row">
                <div class="col-sm-6 col-lg-3">
                    <div class="aboutus_thumb">
                        <img class="img-fluid w100" src="{{ asset('front/images/about/1.jpg') }}" alt="About1 Image">
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3">
                    <div class="aboutus_thumb">
                        <img class="img-fluid w100" src="{{ asset('front/images/about/2.jpg') }}" alt="About2 Image">
                    </div>
                    <div class="aboutus_thumb">
                        <img class="img-fluid w100" src="{{ asset('front/images/about/3.jpg') }}" alt="About3 Image">
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3">
                    <div class="aboutus_thumb">
                        <img class="img-fluid w100" src="{{ asset('front/images/about/4.jpg') }}" alt="About4 Image">
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3">
                    <div class="aboutus_thumb">
                        <img class="img-fluid w100" src="{{ asset('front/images/about/5.jpg') }}" alt="About5 Image">
                    </div>
                    <div class="aboutus_thumb">
                        <img class="img-fluid w100" src="{{ asset('front/images/about/6.jpg') }}" alt="About6 Image">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-xl-10 m-auto pt30">
                    ...
                    <div class="about_us_content mb30 mt15">
                        <h4 class="title">Since 1985, we’re creating the awesome products & promise to give high quality in
                            the eCommerce market for all our customers residing any part of the world.</h4>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-lg-3">
                            <div class="team_member">
                                <div class="thumb">
                                    <img class="img-fluid" src="{{ asset('front/images/team/1.jpg') }}" alt="1.jpg">
                                    <div class="overylay">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="team_member">
                                <div class="thumb">
                                    <img class="img-fluid" src="{{ asset('front/images/team/2.jpg') }}" alt="2.jpg">
                                    <div class="overylay">
                                        <ul class="social_icon text-center">
                                            <li class="list-inline-item"><a href="#"><i class="fab fa-facebook"></i></a>
                                            </li>
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="team_member">
                                <div class="thumb">
                                    <img class="img-fluid" src="{{ asset('front/images/team/3.jpg') }}" alt="3.jpg">
                                    <div class="overylay">
                                        <ul class="social_icon text-center">
                                            <li class="list-inline-item"><a href="#"><i class="fab fa-facebook"></i></a>
                                            </li>
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="team_member">
                                <div class="thumb">
                                    <img class="img-fluid" src="{{ asset('front/images/team/4.jpg') }}" alt="4.jpg">
                                    <div class="overylay">
                                        <ul class="social_icon text-center">
                                            <li class="list-inline-item"><a href="#"><i class="fab fa-facebook"></i></a>
                                            </li>
                            ...
                            <div class="swiper-slide">
                                <div class="zmart_testimonial1">
                                    ...
                                    <div class="testimonial_contents text-center">
                                        <p class="main_title">Sallum dictum felis eu pede mollis pretium. Integer tincidunt.
                                            Cras dapibus. Vivamus elementum semper nisi. Aenean vulputate eleifend tellus.
                                            Aenean leo ligula, porttitor eu lorem dolor ipsum.</p>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-md-4 col-lg-2">
                    <div class="partner_item mb30-sm">
                        <img src="{{ asset('front/images/partners/1.png') }}" alt="1.png">
                    </div>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-2">
                    <div class="partner_item mb30-sm">
                        <img src="{{ asset('front/images/partners/2.png') }}" alt="2.png">
                    </div>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-2">
                    <div class="partner_item mb30-sm">
                        <img src="{{ asset('front/images/partners/3.png') }}" alt="3.png">
                    </div>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-2">
                    <div class="partner_item mb30-sm">
                        <img src="{{ asset('front/images/partners/4.png') }}" alt="4.png">
                    </div>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-2">
                    <div class="partner_item mb30-sm">
                        <img src="{{ asset('front/images/partners/5.png') }}" alt="5.png">
                    </div>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-2">
                    <div class="partner_item mb30-sm">
                        <img src="{{ asset('front/images/partners/6.png') }}" alt="6.png">
                    </div>
                </div>
            </div>
        </div>
