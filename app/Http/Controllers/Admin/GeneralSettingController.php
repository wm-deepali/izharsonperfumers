...
class GeneralSettingController extends Controller
{
    ...
    public function accountSetting()
    {
        ...
        $statuses = PaymentGatewayStatus::pluck('is_active', 'gateway')->toArray();

        return view('admin.account-setting.index', compact('passwords', 'mail', 'states', 'settinggst', 'datas', 'cities', 'countrys', 'bank', 'statuses'));
    }

    public function togglePaymentGateway(Request $request)
    {
        $request->validate([
            'gateway' => 'required|in:ccavenue,cashfree,bank',
            'is_active' => 'required|boolean',
        ]);

        PaymentGatewayStatus::updateOrCreate(
